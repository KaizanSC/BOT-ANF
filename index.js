...
import { initDB } from "./database.js"; // Import do DB
...
for (const folder of commandFolders) {
  const commandFiles = (await fs.readdir(path.join(__dirname, "commands", folder))).filter(file => file.endsWith(".js"));
...
app.get("/", (req, res) => res.send("Bot está rodando com sucesso 🚀"));
